...
module.exports = {
  ...
  enterPrinterBuffer: function (text, resolve, reject) {
    exec(resolve, reject, "Printer", "enterPrinterBuffer", [text]);
  },
  exitPrinterBuffer: function (text, resolve, reject) {
    exec(resolve, reject, "Printer", "exitPrinterBuffer", [text]);
  },
