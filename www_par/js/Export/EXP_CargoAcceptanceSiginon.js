...
function HHT_ExpCargoAcceptance_SaveDetails() {
    ...
    var errmsg = "";
    var AWBNo = $('#txtAWBNo').val();
    Driverxml = '<ROOT><DriverDetails VCTNO="" DRIVER_NAME="'+$('#txtDriverName').val()+'" DRIVER_ID="'+$('#txtDriverid').val()+'" Driver_DOB="'+$('#txtDOB').val()+'" VEHICLE_NO="'+$('#txtVehicleNumber').val()+'" /></ROOT>';
    AWBXml = '<ROOT><AWBData AWBNo="'+$('#txtAWBNo').val()+'"  AWB_NOP="'+$('#txtAWBpkgs').val()+'" AWB_WT="'+$('#txtAWBWt').val()+'" Pcs="'+$('#txtReceivedPkgs').val()+'" Weight="'+$('#txtReceivedGrossWt').val()+'" WtUnit="KG" TareWt="'+$('#txtTareWt').val()+'"  EquiType="'+$('#ddlEquipmentType').val()+'" EquiSubType="'+$('#ddlULDSK1').val()+'" NetWt="'+$('#txtReceivedNetWt').val()+'" AgtCode="44" AgtName="'+$('#txtCustomerName').val()+'" Dest="'+$('#ddlDestination').val()+'" offpoint="'+$('#ddlOffPoints').val()+'" ULDType="'+$('#txtULDTyped').val()+'" ULDNumber="'+$('#txtULDNumber').val()+'" ULDOwner="'+$('#txtOwner').val()+'" ULDSeqNo="-1" ShipNo="-1"/></ROOT>';
    DimLinexml = '<ROOT><DIMData SeqNo="0" Length="'+$('#Length1').val()+'" Width="'+$('#Width1').val()+'" Height="'+$('#Height1').val()+'" Pieces="'+$('#Pieces1').val()+'" Vol="'+$('#Volume1').val()+'" VolCode="'+$('#ddlUOM1').val()+'" /></ROOT>';
